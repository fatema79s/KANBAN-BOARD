...
/**
 * DialogPrimitive component for displaying modal dialogs
 *
 * @param {Object} props - The component's properties
 * @param {string} props.title - The title of the dialog
 * @param {JSX.Element} props.triggerComponent - The component that triggers the dialog
 * @param {JSX.Element} props.children - The children components displayed inside the dialog
 * @param {boolean} props.isOpen - A boolean to determine if the dialog is open or closed
 * @param {Function} props.setOpen - A function to set the dialog's open state
 *
 * @returns {JSX.Element} - The rendered DialogPrimitive component
 */
