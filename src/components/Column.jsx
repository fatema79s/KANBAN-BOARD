...
/**
 * Column component that renders a list of tasks inside a column layout
 *
 * @param {Object} props - The component's properties
 * @param {string} props.title - The title of the column
 * @param {Array} props.tasks - An array of task objects to display within the column
 * @param {string} props.tasks[].id - The unique identifier for each task
 * @param {string} props.tasks[].title - The title of each task
 *
